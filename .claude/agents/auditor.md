...
10. **Fonts.** Every face is TWK Lausanne Pan (300 / 550 / 700). Any other face — Space Mono (removed from the system), Inter, system-ui, Apercu in body copy, an unspecified Paper default — is P0 (Rule 09). For Paper deliverables, also confirm the builders ran the font preflight: if the file is missing Lausanne Pan and a builder composed typography anyway, that's P0.
